...
// $(function(){$(window).on("scroll load",function(){$("img.lazy").each(function(){$(this).attr("src")||(triggerpoint=Math.round(.8*$(window).height()+$(window).scrollTop()),counterElement=Math.round($(this).offset().top+$(this).height()),counterElement>triggerpoint-250&&counterElement<triggerpoint+250&&$(this).attr("src",$(this).attr("data-original")))})})});